...
const whiteCanvasWidth = 410;
const whiteCanvasHeight = 530;
...
if(showtxt){
  ...
  if(textsTY==0){
      ...
      push()
        ...
        translate(width/2-177,50+textY,svgls[3].width/3)
        scale(1)
        strokeWeight(2)
        beginShape();
        vertex(0, 1.9);
  ...
  if(textsTY==1){
    ...
    for(let i=0;i<textlist.length;i++){
      ...
      push()
      imageMode(CENTER);
      image(svgls[3],width/2,height-300+textY+60*i,svgls[3].width/3)
      ...
      text(textlist[i][0],width/2-svgls[3].width/6,height-320+textY+i*60)
      textSize(20)
    
      fill(64, 120, 156)
    
      text(textlist[i][1],width/2+svgls[3].width/6-textlist[i][1].length*10,height-320+textY+i*60)
      pop ()
      }
    ...
    if(textContent){
      ...
      image(svgls[3],width/2,50,svgls[3].width*logoScale/2,svgls[3].height*logoScale/2)
  ...
  if(textsTY==2){
    ...
    push()
    imageMode(CENTER);
    image(svgls[3],width/2,height-300+textY,svgls[3].width/3)
    ...
    text(textContent,width/2-svgls[3].width/6,height-270+textY)
    pop ()
  }
