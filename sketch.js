...
function preload(){
  ...
  // svgls[0]=loadSVG("./svg/"+0+".svg")
  // kkk=loadSVG("./svg/0.svg")


  // console.log(svgls[0])
  // for(let i=0;i<3;i++){

  //   svgls[i]=loadSVG("./svg/"+i+".svg")
...
function draw() {
  ...
  lineX=parseInt(document.getElementById("linex").value)
  ...
  // scale()
  // image(kkk,width/2,logoY+100,220,220)
  // image(svgls[svgtt],width/2,logoY+100,220,220)
