...
const whiteCanvasWidth = 400;
const whiteCanvasHeight = 400;
...
function draw() {
  ...
  lineRotation=parseInt(window.parent.document.getElementById("liner").value)
  ...
  if(frameCount%60==0){
    ...
    lineScale=sessionStorage.getItem("lineScale")?sessionStorage.getItem("lineScale")*0.8:1

    logoScale=sessionStorage.getItem("logoscale")?sessionStorage.getItem("logoscale")*0.8:1
...
//poster2 text1
  if(showtxt){
      ...
      if(textsTY==0){
        ...
        // textAlign(CENTER) text1 海报
        textSize(75)
      
        fill(0)
        textLeading(65);
      
        text(textContent,50,height-300+textY)
        pop ()
      }
      if(textsTY==1){
        ...
        for(let i=0;i<textlist.length;i++){
          ...
          translate(width/2-353/2,height-315+textY+55*i,svgls[3].width/3)
          scale(1)
          strokeWeight(2)
          beginShape();
          vertex(0, 1.9);
          ...
          text(textlist[i][0],width/2-10-svgls[3].width/6+80,height-320+textY+i*55)
          textSize(20)
        
          fill(64, 120, 156)
          textLeading(20);
          text("·",width/2+30,height-345+textY+i*55)
          text(textlist[i][1],width/2+45,height-345+textY+i*55)
          pop ()
          }
      ...
      if(textsTY==2){
        ...
        push()
          ...
          translate(width/2-177,height-300+textY,svgls[3].width/3)
          scale(1)
          strokeWeight(2)
          beginShape();
          vertex(0, 1.9);
        ...
        text(textContent,30,height-280+textY)
        text("·",20,height-280+textY)
        pop ()
      }
}
