...
if(showtxt){
  ...
  if(textsTY==0){
    ...
    text(textContent,75,height-300+textY)
    pop ()
  }
  if(textsTY==1){
    ...
    for(let i=0;i<textlist.length;i++){
      ...
      translate(width/2-353/1.34,height-315+textY+55*i,svgls[3].width/3)
      scale(1.5)
      strokeWeight(2)
      beginShape();
      vertex(0, 1.9);
      ...
      text(textlist[i][0],width/2-10-svgls[3].width/6,height-320+textY+i*55)
      textSize(20)
  ...
  if(textsTY==2){
    ...
    push()
      ...
      translate(width/2-353/1.34,height-300+textY,svgls[3].width/3)
      scale(1.5)
      strokeWeight(2)
      beginShape();
      vertex(0, 1.9);
